...
BOOKS = [
    ...
    Book(2, 'Be Fast with FastAPI', 'codingwithroby', 'A very great book!', 5, 2013),
...
async def read_book_by_date(book_date: int = Query(gt=1999, lt=2031)):
    books_to_return = []
    for book in BOOKS:
...
# assign new id, if no books, id=1, else, last book id + 1
